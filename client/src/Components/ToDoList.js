...
const ToDoList = () => {
  ...
  useEffect(() => {
    axios.get('https://to-do-list-api-zeta.vercel.app/tasks')
  ...
  const inputHandler = () => {
    if (task.trim() !== '') {
      axios.post('https://to-do-list-api-zeta.vercel.app/tasks', { title: task.trim() })
        .then(response => {
  ...
  const deleteListItem = (id) => {
    axios.delete(`https://to-do-list-api-zeta.vercel.app/tasks/${id}`)
      .then(() => {
  ...
  if (taskToUpdate) {
    ...
    axios.put(`https://to-do-list-api-zeta.vercel.app/tasks/${id}`, { completed: !taskToUpdate.completed })
      .then(response => {
  ...
  const updateTask = () => {
    if (editText.trim() !== '') {
      axios.put(`https://to-do-list-api-zeta.vercel.app/tasks/${editIndex}`, { title: editText })
        .then(response => {
